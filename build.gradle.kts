...
kotlin {
    ...
    val xcf = XCFramework("Bitflags")

    macosArm64 {
        binaries.framework { baseName = "Bitflags"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Bitflags"
    ...
    swiftExport {
        moduleName = "Bitflags"
        flattenPackage = "io.github.kotlinmania.bitflags"
    }

    android {
        namespace = "io.github.kotlinmania.bitflags"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "bitflags-kotlin", version.toString())

    pom {
        name.set("bitflags-kotlin")
        description.set("Kotlin Multiplatform port of bitflags - type-safe bit flag sets")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/bitflags-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/bitflags-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/bitflags-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/bitflags-kotlin.git")
        }
    }
}
