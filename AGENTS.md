# Agent guide - bitflags-kotlin

This file is the quick-reference operating contract for bitflags-kotlin. The longer
...
bitflags-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`bitflags`](https://crates.io/crates/bitflags). Upstream Rust is the behavioral oracle while the
