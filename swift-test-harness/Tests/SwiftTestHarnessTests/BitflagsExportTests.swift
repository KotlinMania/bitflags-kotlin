...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Bitflags.swiftmodule/`
...
//      `import Bitflags` above would fail at compile time.
//
//   2. The static archive `libBitflags.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Bitflags" }` and
//      `flattenPackage = "io.github.kotlinmania.bitflags"` configuration in
...
//      via the `BitflagsLibrary` product.
//
