...
public class TestFlags private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestFlags>> =
            listOf(
                Flag("A", A),
                Flag("B", B),
                Flag("C", C),
...
public class TestFlagsInvert private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestFlagsInvert>> =
            listOf(
                Flag("ABC", ABC),
                Flag("A", A),
                Flag("B", B),
...
public class TestZero private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestZero>> =
            listOf(
                Flag("ZERO", ZERO),
            )
...
public class TestZeroOne private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestZeroOne>> =
            listOf(
                Flag("ZERO", ZERO),
                Flag("ONE", ONE),
            )
...
public class TestUnicode private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestUnicode>> =
            listOf(
                Flag("一", 一),
                Flag("二", 二),
            )
...
public class TestOverlapping private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestOverlapping>> =
            listOf(
                Flag("AB", AB),
                Flag("BC", BC),
            )
...
public class TestOverlappingFull private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestOverlappingFull>> =
            listOf(
                Flag("A", A),
                Flag("B", B),
                Flag("C", C),
...
public class TestExternal private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestExternal>> =
            listOf(
                Flag("A", A),
                Flag("B", B),
                Flag("C", C),
...
public class TestExternalFull private constructor(
    ...
    public companion object {
        ...
        public val FLAGS: List<Flag<TestExternalFull>> =
            listOf(
                Flag("", UNNAMED_ALL),
            )
